...
interface AppointmentResponsePros {
  onSubmit: (data: { isAccepted: boolean; message: string }) => void;
}

const AppointmentResponse = ({ onSubmit }: AppointmentResponsePros) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <button disabled={!canSubmit} onClick={()=> canSubmit&& onSubmit({isAccepted,message})}>
            Submit
        </button>
      </fieldset>
    </div>
